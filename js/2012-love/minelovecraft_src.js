            ...
            // Demo code -------------------------------------------------------
            Z=[];
            H=(c.width=c.height=innerHeight)/2; // Slightly adapted to allow iframe-based embedding
            N=149;
            ...
            P=function(w,h,t,u,r){                                                          // Function that draws a block (with height >= 0)
                ...
                a.fillStyle='hsl('+t*20+','+99*!r+'%,'+Math.floor(99*Math.pow(u/10,1/C))+'%)'; // HSL color scheme saved my day ! lightness management a bit hard to explain here
                a.beginPath();
                a.moveTo(x+w,y);
                a.lineTo(x,y+w/2);
                a.lineTo(x-w,y);
                a.lineTo(x-w,(y-=h*H/(2*D+1)));
                a.lineTo(x,y-w/2);
                a.lineTo(x+w,y);
                a.fill()
            };
